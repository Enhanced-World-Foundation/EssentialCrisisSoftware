...
## 4. Why Open Source Community / Crowd Development?
Decentralization is a resilience principle - no central node to break or infiltrate, thus so system need to be transparent and community-maintained. Designed so even knowing the code, or extraction of few nodes / users - will not affect whole. 
An open-source approach ensures:
✓ **Security through transparency**—anyone can audit code  
